...
const Header: React.FC = () => {
    return (
        <header >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px', backgroundColor: '#5B3E18', width: '100%' }}>
            ...
            <button style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#EDD2A8' }}>Home</button>
            </li>
            <li style={{ margin: '0 10px' }}>
            ...
            <li style={{ margin: '0 10px' }}>
            <button style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#EDD2A8' }}>Account</button>
            </li>
            </ul>
            </nav>
        </div>
